...
public class CommentListFileDatasource implements Datasource<CommentList> {
    ...
    public CommentList readData() {
        ...
        try {
            ...
            while ( (line = buffer.readLine()) != null ){
                ...
                String nameTeamActivity = data[0].trim();
                String name = data[1].trim();
                String comment = data[2].trim();
                // เพิ่มข้อมูลลงใน list
                comments.addNewComment(nameTeamActivity,name,comment);
            }
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    ...
    public void writeData(CommentList data) {
        ...
        try {
            ...
            for (Comment comments : data.getComments()) {

                String line = comments.getNameTeamActivity() + "," + comments.getName() + "," + comments.getComment() ;
                buffer.append(line);
                buffer.append("\n");
            }
        } catch (IOException e) {
