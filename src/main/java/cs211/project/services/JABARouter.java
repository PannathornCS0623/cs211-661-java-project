...
public final class JABARouter {
    ...
    private static JABARouter router;
    ...
    public static void goTo(String routeLabel, Object account) throws IOException {
        RouteScene route = (RouteScene)routes.get(routeLabel);
    ...
    public static void goTo(String routeLabel, Object account, Object event) throws IOException {
        RouteScene route = (RouteScene)routes.get(routeLabel);
        route.account = account;
        route.event = event;
    ...
    public static void goTo(String routeLabel, Object account, Object event, Object team) throws IOException {
        RouteScene route = (RouteScene)routes.get(routeLabel);
        route.account = account;
        route.event = event;
        route.team = team;
    ...
    public static Object getAccount() {
        return currentRoute.account;
    }
    public static Object getEvent() { return currentRoute.event;}
    public static Object getTeam() { return  currentRoute.team;}
    ...
    private static class RouteScene {
        ...
        private static String getWindowTitle() {
            return JABARouter.windowTitle != null ? JABARouter.windowTitle : "";
        }

        private static double getWindowWidth() {
            return JABARouter.windowWidth != null ? JABARouter.windowWidth : JABARouter.WINDOW_WIDTH;
        }

        private static double getWindowHeight() {
            return JABARouter.windowHeight != null ? JABARouter.windowHeight : JABARouter.WINDOW_HEIGHT;
        }
    }
}
